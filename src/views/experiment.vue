<template>
  <div>
    ...
    <div class="container" :style="{fontSize: fontSize+'px', width: divWidth+'%'}">
      ...
      <p>如何开通云产品？</p>
      <p>
        1）购买成功后，可登陆阿里云账号，访问提货券后台（控制台-费用中心-提货券）
        2）在有效期内的提货券，可点击右侧的“使用”，进行云产品的开通。提货券列表
      ...
      <p>提货券转移说明</p>
      <p>
        1、转移：提货券可被转移给任何一个阿里云账户，每张提货券只能被转移1次；
        2、有效期：以官网提货券上显示为准；
        3、核销：提货券仅且只能在阿里云官网核销，点击提货券“开通云产品”开始核销；一旦被核销，提货券所对应的产品即刻生效；
        4、费用：提货券转移所产生的费用，由买卖双方自由决定，与阿里云无关，阿里云不收取任何转移费用；
        5、发票：被转移后的提货券，阿里云不予以开发票，需由转让方出具发票；
        提货券转移说明
      </p>
    </div>
  </div>
